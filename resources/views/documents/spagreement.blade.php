...
@section('main-content')
	...
	<p>
		{{ $sellerRow }}, toliau vadinama "Pardavėju" atstovaujama @if(empty($documentInfo['seller_representative']))________________________________________ @else{{$documentInfo['seller_representative'] }}@endif ir UAB "Agaras",
