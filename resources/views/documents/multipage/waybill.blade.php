<div id="kv_id">
    <table class="no-border">
        ...
        <tr height="20px">
            <td><strong>Serija {{ $documentInfo['doc__k_v']['serial'] }}
                    Nr. {{ $documentInfo['doc__k_v']['no'] }}</strong></td>
        </tr>
        <tr height="30px">
        ...
        <tr>
            <td class="text-left font-8">
                Krovinio gavėjas: UAB &quot;Agaras&quot;, Agaro g. 5, Balandiškių k. Pabiržės sen., Biržų r. LT-41385,
                Lietuva.
            </td>
        </tr>
        <tr>
            <td class="text-left font-8">Tel. (8-450) 43111, (8-450) 59339, faks. (8-450) 43112 Įmonės kodas 154742821
                PVM mokėtojo kodas LT547428219
            </td>
        </tr>
    </table>
    ...
    <p>
        Surašyti 2 važtaraščio egzemplioriai ir perduoti gyvulių laikytojui ir vežėjui. Vežėjo turimas egzempliorius
        paliekamas paskirties vietoje.
    </p>
    <table class="no-border no-collapse table-text-left">
        <tr>
