<div class="sf">
    <table class="no-border">
        ...
        <tr height="20px">
            <td><strong>
                    <small>Serija</small> {{ $documentInfo['doc__s_f']['serial'] }}
                    Nr. {{ $documentInfo['doc__s_f']['no'] }}</strong></td>
        </tr>
        <tr>
            <td height="30px">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i', $documentInfo['travel_start_datetime'])->format('Y') }}
        ...
        <tr>
            <td class="text-left font-8">
                <strong>Pirkėjas: UAB &quot;Agaras&quot;, Agaro g. 5, Balandiškių k. Pabiržės sen., Biržų r. LT-41385,
                    Lietuva.</strong>
            </td>
        </tr>
        <tr>
            <td class="text-left font-8"><strong>Tel. (8-450) 43111, (8-450) 59339, faks. (8-450) 43112</strong> Įmonės
                kodas <strong>154742821</strong> PVM mokėtojo kodas <strong>LT547428219</strong></td>
        </tr>
    </table>
    <table class="no-border no-collapse table-text-left margin-10">
        ...
        <tr>
            <td colspan="2" class="text-center text-below">(juridinio asmens pavadinimas arba fizinio asmens vardas,
                pavardė, adresas, tel., faks., el. pašto adresas)
            </td>
        </tr>
    </table>
    <p>
    ...
    <p>
        Pakrovimo vieta {{ $loadAddressRow }} Pakrovimo data: {{ substr($loadDateRow, 0, 10) }}
    </p>
    <p class="no-margin">
    ...
    <table class="no-border no-collapse table-text-left">
        <tr>
            ...
            <td class="solid-line"
                width="75%">{{ $documentInfo['user_name'] }} {{ $documentInfo['user_position'] }}</td>
        </tr>
        <tr>
    ...
    <table class="no-border no-collapse table-text-left margin-10">
        <tr>
            <td>Pardavėjas</td>
            <td class="solid-line"
                width="90%">{{ $documentInfo['seller_representative'] }} {{ $documentInfo['seller_position'] }}</td>
        </tr>
        <tr>
            <td colspan="2" class="text-center text-below">(parašas, vardas, pavardė ir pareigos)</td>
        </tr>
