...
@section('main-content')
	...
	<table class="no-border no-collapse table-text-left">
		<tr>
			...
			<td class="solid-line" width="80%"><span style='width: 50%;display:inline-block'>{{ $documentInfo['doc__v_g']['held_place_number'] }}</span><span style='width: 50%;display:inline-block'>{{ $documentInfo['doc__v_g']['herd_number'] }}</span></td>
		</tr>
		<tr>
	...
	<ol class="list-rules">
		<li>
			Gyvūnų laikymo vietoje išvežamiems gyvūnams netaikomi / <span style='text-decoration: line-through; font-weight: normal !important;'>taikomi</span> (nereikalingą žodį išbraukti) pagal
