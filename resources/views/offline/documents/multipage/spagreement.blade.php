<table class="no-border">
	<tr>
		<td><h2>GYVULIŲ PIRKIMO — PARDAVIMO SUTARTIS&nbsp;&nbsp;{{ $documentInfo['doc__p_p']['serial'] }} {{ $documentInfo['doc__p_p']['no'] }}</h2></td>
	</tr>
	<tr>
...
<p>
	{{ $sellerRow }}, toliau vadinama "Pardavėju" atstovaujama ________________________________________ ir UAB "Agaras",
...
<ol class="level-1">
	...
	<li>
		...
		<ol>
			<li>
				...
				<ol>
					<li>Sutartu laiku paruošti gyvulius pardavimui laikantis teises aktų, reglamentuojančių gyvulių pirkimo -pardavimo tvarką.</li>
					<li>Neparduoti gyvulių šertų pašarais ir pašariniais priedais, kurie blogiua skerdenos kokybę.</li>
			...
			<li>
				...
				<ol>
					<li>Nupirkti gyvulius laikantis teisės aktų, reglamentuojančių gyvulių pirkimo - pardavimo tvarką, reikalavimų.</li>
					<li>
						Mokėti už gyvulius pagal vertintų skerdenų svorius ir kokybę šias bazines (R raumeningumo ir 3 riebumo klasės) kainas:<br />
						<strong>Bulių</strong>{{ $bullPriceRow }} EUR/kg; <strong>Telyčių</strong>{{ $heiferPriceRow }} EUR/kg; <strong>Karvių</strong>{{ $cowPriceRow }} EUR/kg.<br/>
						Visa galvijų skerdenų kainų lentelė pateikiama priede prie šios gyvulių pirkimo - pardavimo sutarties.
					</li>
					<li>Atsiskaityti su Pardavėju mokėjimo pavedimu pervedant pinigus į Pardavėjo nurodytą bankinę sąskaitą per 15 darbo dienų.</li>
					<li>
	...
	<li>
		...
		<ol>
			...
			<li>Sutartis sudaroma dviem egzemplioriais, turinčiais vienodą juridinę galią, po vieną kiekvienai sutarties šaliai.</li>
