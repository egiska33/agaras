...
<p>
	Gyvuliai priimti pagal gyvulių važtaraštį (kitą dokumentą) Nr. ____________________________________
</p>
<p>
	Pakrovimo data ir laikas: {{ $loadDateTime }}
</p>
...
<table class="no-outer-border margin-10">
	<tr>
		<td width="28%">Gyvulio rūšis ir identifikavimo nr.</td>
...
<table class="no-border no-collapse table-text-left">
	<tr>
		...
		<td class="solid-line" width="78%">{{ $documentInfo['seller_name'] }}</td>
	</tr>
	<tr>
