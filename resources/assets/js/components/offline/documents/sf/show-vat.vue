<template>
    <div id='docContainer'>
        <div id='innerDocContainer'>
            ...
            <p>
                Asmens/Įmonės kodas <span class='field_2'></span> PVM mokėtojo kodas <span class='field_3'></span>
            </p>
            <p>
        	...
        	<table class="no-outer-border hugeTable">
        		...
        		<tr class="table-text-left">
        			...
        			<td class='field_19 text-center'></td>
        		</tr>
        		<tr class="table-text-left">
        		...
        		<tr class="table-text-left" height="30px">
        			...
        			<td colspan="9" class="no-border solid-line field_21"></td>
        			<td class='field_22 text-center'></td>
        		</tr>
        		<tr>
    ...
    export default {
        ...
        methods:
        {
                    ...
                    offlineDB.get('animals', (cursor) => {
                        if(cursor.value.seller_code == pivot.seller_code)
                        {
                            ...
                            if((currAnimal.inclination == '1') || (currAnimal.inclination == '2') || (currAnimal.inclination == '3'))
                            {
                                ...
                                row.append("<td>"+animalCode+"-"+currAnimal.animal_id+"</td>");
                        ...
                        if(_.pivot.seller_pvm_rate == '21')
                        {
                            ...
                            $('.field_19').text(((totalAnimalsPriceField * 1.21) - totalAnimalsPriceField).toFixed(2));
                        ...
                        $(".field_21").text(priceInWords);
                        $(".field_22").text(totalPrice);
            ...
            fillDocumentData: function()
            {
                ...
                if(_.pivot.travel_start_date) field_12 = _.pivot.travel_start_date +" "+ _.pivot.travel_start_hour+":"+_.pivot.travel_start_minute;
